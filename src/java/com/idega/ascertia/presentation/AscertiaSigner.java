...
/**
 * 
 * TODO, do a servlet that does the hashcodeing via util classes, sending and receiving and verification
 * BYRJA a add mvn deploya jörunum sem tharf
 * 
...
public class AscertiaSigner extends Block {
	...
	public void main(IWContext iwc) throws RemoteException{
		...
		String documentURL = "http://localhost:8080/content/files/public/form.pdf";
		...
		script.addScriptLine("GoSign_SetTargetURL('"+documentURL+"');");
